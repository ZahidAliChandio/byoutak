const RightAngle=()=>{
    return(
        <div className="absolute left-0 top:[10%] sm:left-[5%] sm:top-[8%] md:left-[15%] md:top-[10%] flex flex-col items-center m-auto mt-7 lg:mt-9 pt-8 sm:pt-10 lg:pt-16 sm:w-11/12 md:w-10/12">
